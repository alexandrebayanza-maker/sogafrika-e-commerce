...
export default async function HomePage() {
  ...
  return (
    <>
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-4">
            {categories.map((category) => (
              <Link
                ...
                className="group flex flex-col items-center gap-3 p-6 rounded-xl bg-white dark:bg-dark-900900/50 border border-gray-300 dark:border-dark-700800/50 hover:border-primary-500/30 hover:shadow-glow transition-all duration-300"
              >
      ...
      {/* Featured Products */}
      <section className="page-section bg-white dark:bg-dark-900900/30">
        <div className="section-container">
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div className="space-y-6">
              ...
              <div className="grid grid-cols-2 gap-4 pt-4">
                <div className="flex items-center gap-3 p-4 rounded-xl bg-white dark:bg-dark-900900/50 border border-gray-300 dark:border-dark-700800/50">
      ...
      <section id="contact" className="page-section">
        <div className="section-container">
          ...
          <div className="grid lg:grid-cols-2 gap-12">
            ...
            {/* Contact Info */}
            <div className="space-y-6">
              <div className="flex items-start gap-4 p-6 rounded-xl bg-white dark:bg-dark-900900/50 border border-gray-300 dark:border-dark-700800/50">
