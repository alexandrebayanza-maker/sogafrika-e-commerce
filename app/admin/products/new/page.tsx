      ...
      <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
        ...
        <div className="glass-card p-6 space-y-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div>
              <label className="block text-dark-300 text-sm mb-1">Product Name *</label>
              <input {...register('name')} className="input-field" placeholder="e.g. HD Security Camera" />
          ...
          <div>
            ...
            <textarea {...register('description')} className="input-field resize-none" rows={4} placeholder="Product description..." />
          </div>
        ...
        <div className="glass-card p-6 space-y-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            <div>
              ...
              <input {...register('price', { valueAsNumber: true })} type="number" step="0.01" className="input-field" placeholder="0.00" />
              {errors.price && <p className="text-red-400 text-xs mt-1">{errors.price.message}</p>}
            </div>
            <div>
              <label className="block text-dark-300 text-sm mb-1">Compare at Price</label>
              <input {...register('compare_at_price', { valueAsNumber: true })} type="number" step="0.01" className="input-field" placeholder="0.00" />
            </div>
            <div>
            ...
            <label className="w-24 h-24 rounded-lg border-2 border-dashed border-dark-600 flex flex-col items-center justify-center cursor-pointer hover:border-primary-500/50 transition-colors">
              {uploading ? (
                ...
                <>
                  ...
                  <span className="text-xs text-dark-500 mt-1">Upload</span>
                </>
              )}
