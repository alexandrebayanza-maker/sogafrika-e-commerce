        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10">
          ...
          <div>
            ...
            <ul className="space-y-2.5">
              ...
              <li><a href="/#about" className="text-dark-400 hover:text-primary-400 text-sm transition-colors">About Us</Link></li>
              <li><a href="/#contact" className="text-dark-400 hover:text-primary-400 text-sm transition-colors">Contact</Link></li>
