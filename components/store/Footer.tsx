...
export default function Footer() {
  return (
    <footer className="bg-white dark:bg-dark-950 border-t border-gray-300 dark:border-dark-700800/50">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10">
          ...
          <div>
            ...
            <ul className="space-y-2.5">
              ...
              <li><a href="/#about" className="text-dark-400 hover:text-primary-400 text-sm transition-colors">About Us</a></li>
              <li><a href="/#contact" className="text-dark-400 hover:text-primary-400 text-sm transition-colors">Contact</a></li>
