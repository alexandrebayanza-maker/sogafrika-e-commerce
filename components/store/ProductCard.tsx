  ...
  return (
    ...
    >
      <Link href={`/products/${product.slug}`} className="group block">
        <div className="relative rounded-xl overflow-hidden bg-white dark:bg-dark-900900/50 border border-gray-300 dark:border-dark-700800/50 hover:border-primary-500/30 transition-all duration-300 hover:shadow-glow">
          {/* Image */}
